(function() {
    ...
    module.exports = function revXPath(node) {
        ...
        for (var i = 1; i < 100; i++) {
            if (res.join('/') == '/som:Order/som:orderItem[' + i + ']/som:entity/som:entityKey/cmn:primaryKey') {
                console.log('/som:Order/som:orderItem[' + i + ']/som:entity/som:entityKey/cmn:primaryKey');
                return null;
